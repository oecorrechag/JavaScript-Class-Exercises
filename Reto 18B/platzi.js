...
var coordenadas = villaplatzi.getBoundingClientRect();

villaplatzi.addEventListener("mousedown", function(e){
...
villaplatzi.addEventListener("mousemove", function(e){
    if(dibujando == true){
        dibujarOtraVez();
        moverCerdo(e.clientX - coordenadas.left, e.clientY - coordenadas.top);
        x = e.clientX - coordenadas.left;
        y = e.clientY - coordenadas.top;
    }
});

villaplatzi.addEventListener("mouseup", function(e){
    if(dibujando == true){
        dibujarOtraVez();
        moverCerdo(e.clientX - coordenadas.left, e.clientY - coordenadas.top);
        x = 0;
